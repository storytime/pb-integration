...
public class TransactionsItem {
    ...
    private List<SubtransactionsItem> subtransactions;
    ...
    public List<SubtransactionsItem> getSubtransactions() {
        return subtransactions;
    }

    public void setSubtransactions(List<SubtransactionsItem> subtransactions) {
