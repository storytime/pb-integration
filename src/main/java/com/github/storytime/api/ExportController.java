...
public class ExportController {
    ...
    public CompletableFuture<List<Map<String, String>>> getOutDataByMonth(@PathVariable("userId") final String userId) {
    ...
    public CompletableFuture<List<Map<String, String>>> getInDataByMonth(@PathVariable("userId") final String userId) {
    ...
    public CompletableFuture<List<Map<String, String>>> getOutDataByYear(@PathVariable("userId") final String userId) {
    ...
    public CompletableFuture<List<Map<String, String>>> getInDataByYear(@PathVariable("userId") final String userId) {
    ...
    public CompletableFuture<List<Map<String, String>>> getOutDataByQuarter(@PathVariable("userId") final String userId) {
    ...
    public CompletableFuture<List<Map<String, String>>> getInDataByQuarter(@PathVariable("userId") final String userId) {
